...
reasons, you can also use `=` for assignments.
...
You can find a quick [guide to markdown here](https://www.rstudio.com/wp-content/uploads/2015/03/rmarkdown-reference.pdf), throughout the course we will see various things markdown can do in the readings and in-class materials.
...
The quotes around "CT", "MA", etc. are essential here. Without the
quotes R will assume there are objects called `CT`, `MA` and
`NY`. As these objects don't exist in R's memory, there will be
an error message.
