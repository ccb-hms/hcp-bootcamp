...
Generally, the [R Epidemiology handbook](https://epirhandbook.com/en/) is a great place to look for how to clean, analyze, and visualize data in R. 
...
- The R Epidemiology handbook chapter on [pivoting](https://epirhandbook.com/en/pivoting-data.html?q=pivot#pivoting-data).
